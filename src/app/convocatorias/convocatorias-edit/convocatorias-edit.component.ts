...
@Component({
  ...
  templateUrl: './convocatorias-edit.component.html',
  styleUrls: ['./convocatorias-edit.component.scss']
})
export class ConvocatoriasEditComponent implements OnInit {
  ...
  update() {
    ...
    else if (!this.validarEmail(model.correo)) {
